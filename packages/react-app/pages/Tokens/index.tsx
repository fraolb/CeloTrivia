...
const Main = () => {
  ...
  return (
    <div className="container w-80 m-1 p-2 text-black">
      ...
      <div className="grid grid-cols-1 gap-2 mb-12">
        {balances.map((tokenBalance, index) => (
          <div
            key={index}
            className="bg-inputDarkBg border border-mainHard w-full text-mainHard rounded-lg shadow-lg p-2 px-4 flex items-center justify-between"
          >
            {tokenBalance && (
              <>
                ...
                <div className="text-2xl font-semibold text-black">
                  {tokenBalance.value !== undefined &&
                    ethers.formatEther(tokenBalance.value)?.substring(0, 4)}
                </div>
              </>
            )}
          </div>
